...
void ht_insert_lookup() {
    ...
    CU_ASSERT_STRING_EQUAL("hello", ioopm_hash_table_lookup(ht, int_elem(5), &success).ptr_value);
...
void ht_insert_already_in_use_key() {
    ...
    bool success;
    CU_ASSERT_STRING_EQUAL("overwritten", ioopm_hash_table_lookup(ht, int_elem(2), &success).ptr_value);
    CU_ASSERT_TRUE(success);
...
void ht_remove() {
    ...
    bool success;
    CU_ASSERT_STRING_EQUAL("hello", ioopm_hash_table_remove(ht, int_elem(5), &success).ptr_value);
    CU_ASSERT_TRUE(success);
...
void ht_remove_non_existing() {
    ...
    bool success;
    CU_ASSERT_PTR_NULL(ioopm_hash_table_remove(ht, int_elem(5), &success).ptr_value);
    CU_ASSERT_FALSE(success);
...
void ht_remove_invalid_key() {
    ...
    CU_ASSERT_PTR_NULL(ioopm_hash_table_remove(ht, int_elem(-6005), &success).ptr_value);
    CU_ASSERT_FALSE(success);
...
void ht_clear() {
    ...
    bool success;
    CU_ASSERT_PTR_NULL(ioopm_hash_table_lookup(ht, int_elem(22), &success).ptr_value);
    CU_ASSERT_FALSE(success);
...
void ht_keys_empty() {
    ioopm_hash_table_t *ht = ioopm_hash_table_create(extract_int_hash_key, compare_int_elements, stringcomp);
    ioopm_list_t *returned_keys = ioopm_hash_table_keys(ht);
    CU_ASSERT_PTR_NULL(ioopm_linked_list_first(returned_keys));
...
void ht_values_empty() {
    ioopm_hash_table_t *ht = ioopm_hash_table_create(extract_int_hash_key, compare_int_elements, stringcomp);
    ioopm_list_t *returned_values = ioopm_hash_table_values(ht);
    CU_ASSERT_PTR_NULL(ioopm_linked_list_first(returned_values));
