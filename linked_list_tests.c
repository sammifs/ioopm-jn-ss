...
void test_iter_create(void)
{
    ...
    CU_ASSERT_EQUAL(ioopm_iterator_next(new_iter).int_value, 420);
...
void test_iter_next(void)
{
    ...
    ioopm_iterator_next(new_iter);
    ioopm_iterator_next(new_iter);
    CU_ASSERT_PTR_NULL(ioopm_iterator_next(new_iter).ptr_value);
...
void test_iter_reset(void)
{
    ...
    ioopm_list_iterator_t *new_iter = ioopm_list_iterator(new_list);
    ioopm_iterator_next(new_iter);
    CU_ASSERT_EQUAL(ioopm_iterator_next(new_iter).int_value, 69);
    ioopm_iterator_next(new_iter);
